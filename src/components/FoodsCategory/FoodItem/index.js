...
import './index.scss'
import { addItemToCart } from '../../../store/modules/takeaway';
const Foods = ({
  id,
  picture,
  name,
      ...
      <div className="goods-info">
        <div className="goods-desc">
          ...
          <div className="goods-sales-volume">
            <span className="goods-num">Monthly Sales {month_saled}</span>
        ...
        <div className="goods-price-count">
          ...
          <div className="goods-count">
            <span className="plus" onClick={() => dispatch(addItemToCart({
              id,
              picture,
              name,
              unit,
